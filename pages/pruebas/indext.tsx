...
function Pruebas() {
  return (
    <Flex flexDirection="column">
      ...
      <Box>Este es un div con dispplay block</Box>

      <Heading textAlign="center" textTransform="uppercase">
        este es un h1
      </Heading>

      <Text backgroundColor="red.100" color="white">
        este es un parrafo
      </Text>

      <Button w="200px" h="30px" margin="0 auto">
        este es un button
      </Button>

      <Flex border="1px" gap="20px" justifyContent="center" margin="30px">
        <Flex w="200px" h="300px" border="1px" flexDirection="column">
          <Flex backgroundColor="pink.800" w="200px" h="200px">
            1
          </Flex>
        ...
        <Flex w="200px" h="300px" border="1px" flexDirection="column">
          <Flex backgroundColor="pink.300" w="200px" h="200px">
            2
          </Flex>
          <Flex w="100%" h="100px" alignItems="center" pl="10px">
        ...
        <Flex w="200px" h="300px" border="1px" flexDirection="column">
          <Flex backgroundColor="pink.500" w="200px" h="200px">
            3
          </Flex>
          <Flex w="100%" h="100px" alignItems="center" pl="10px">
      ...
      >
        ...
        <Flex flexDirection="column">
          <Heading margin="0" fontWeight="800" fontSize="38px" marginTop="20px">
            AKINWUMI MICHAEL
          </Heading>
          <Text textAlign="center" color="red.300" marginBottom="30px">
            Product Design Track
          </Text>
        </Flex>
        <Flex w="495px" h="84px" flexDirection="column">
          <Text textAlign="center">
            I choose product design because i love seeing beautiful interfaces
            and to be able to solve user’s problems.
          </Text>
        ...
        <Flex gap="25px" marginBottom="30px" mt="20px">
          <Button w="200px" h="40px" bg="gray.500">
            Contact Me
          </Button>
          <Button w="200px" h="40px" bg="pink.200">
            Hire Me
          </Button>
        </Flex>
      </Flex>
      ...
      >
        <Flex w="250px" flexDirection="column">
          <Image
            ...
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2_80RhOWrfm7UONWzCs9sUSLsyzk2bfS2LHhBip4RsPKvaqY73g3cnuHGrsP21SSwC2I&usqp=CAU"
          />
          <Flex
            flexDirection="column"
            alignItems="center"
          ...
          >
            ...
            <Text textAlign="center">
              Lorem ipsum dolor sit amet consectetur, Ducimos,repudiandae
        ...
        <Flex w="250px" flexDirection="column">
          <Image
            borderTopRadius="10px"
            src="https://img.freepik.com/fotos-premium/mujer-joven-haciendo-senderismo-sentinel-dome-lookout-parque-nacional-yosemite_242111-17810.jpg"
          />
          <Flex
            flexDirection="column"
            alignItems="center"
