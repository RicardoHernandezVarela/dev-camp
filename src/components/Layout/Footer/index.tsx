...
function Footer() {
  return (
    <Flex bg="#74c69d" w="100%" py="55px" px="131px" mt="20px" justifyContent="space-between">
      <Flex border="1px" gap="30px">
        <svg
          className="svg-icon"
          viewBox="0 0 20 20"
        ...
        <svg className="svg-icon" viewBox="0 0 20 20"  style={{ width: "18px", height: "18px" }}>
          <path
            fill="white"
